            ...
            <Card style="margin-bottom: 10px">
                ...
                <Form inline>
                        ...
                        <Input v-model="searchConf.title" clearable placeholder="新闻标题"></Input>
                                        ...
                                        <FormItem style="margin-bottom: 0">
                    <Select v-model="searchConf.device" clearable placeholder='设备类型(0不限1phone2pc)' style="width:100px">
                        ...
                        <Option value="3">Option3</Option>
                                        ...
                                        <FormItem style="margin-bottom: 0">
                    <Select v-model="searchConf.status" clearable placeholder='状态(0禁用1启用)' style="width:100px">
                        <Option value="1">Option1</Option>
                        <Option value="2">Option2</Option>
                        <Option value="3">Option3</Option>
                    </Select>
                    ...
                    <Upload type="drag"
                        ...
                        <div style="width: 58px;height:58px;line-height: 58px;">
                            <Icon type="ios-camera" size="20"></Icon>
                                ...
                                <FormItem label="设备类型(0不限1phone2pc)" prop="device">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                // 初始化表格列
                columnsList:[{title:"新闻id",key:"news_id",align:"center"},{title:"新闻类型id",key:"news_type_id",align:"center"},{title:"新闻标题",key:"title",align:"center"},{title:"新闻封面",key:"img",align:"center"},{title:"新闻简介",key:"synopsis",align:"center"},{title:"设备类型(0不限1phone2pc)",key:"device",align:"center"},{title:"状态(0禁用1启用)",key:"status",align:"center"},{title:"创建时间",key:"gmt_create",align:"center"},{title:"更新时间",key:"gmt_modified",align:"center"},{title:"操作",key:"handle",align:"center",handle:["edit","delete"]}],
                // 表格数据
                tableData: [],
                // 表格显示分页属性
                tableShow: {
